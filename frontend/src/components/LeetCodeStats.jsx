    ...
    try {
      ...
      const formattedStats = {
        ...
        rating: data.contestRanking?.rating != null
          ...
          : 'N/A', totalContestsAttended: data.contestRanking?.attendedContestsCount || 0,
  ...
  const upsertLeetCodeData = async (leetcodeData) => {
    try {
      ...
      const contestRankingData = {
        leetcode_recent_contest_rating: leetcodeData.rating
          ? Math.round(parseFloat(leetcodeData.rating))
          : 0,
        leetcode_max_contest_rating: leetcodeData.rating
          ? Math.round(parseFloat(leetcodeData.rating))
          : 0,
      ...
      >
        ...
        <motion.div variants={itemVariants} className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="bg-gray-700/50 p-4 rounded-lg">
            ...
            <p className="text-xl font-bold">{stats.rating ? Math.round(stats.rating) : 'N/A'}</p>
          </div>
